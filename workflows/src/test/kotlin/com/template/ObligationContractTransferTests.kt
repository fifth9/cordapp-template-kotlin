...
import com.template.states.Obligation
import com.template.contracts.ObligationContract
import com.template.contracts.ObligationContract.Companion.OBLIGATION_CONTRACT_ID
    ...
    fun `must handle multiple command values`() {
        ledgerServices.ledger {
            transaction {
                ...
                this `fails with` "Required com.template.contracts.ObligationContract.Commands command"
            }
            transaction {
                output(OBLIGATION_CONTRACT_ID, oneDollarObligation)
